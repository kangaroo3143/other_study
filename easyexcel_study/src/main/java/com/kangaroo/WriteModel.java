...
public class WriteModel extends BaseRowModel {
    ...
    @ExcelProperty(value = {"表头2"},index = 3)

    private long p4;

    @ExcelProperty(value = {"表头3"},index = 4)
    private String p5;

    @ExcelProperty(value = {"表头4"},index = 5)
    private float p6;

    @ExcelProperty(value = {"表头5"},index = 6)
    private BigDecimal p7;

    @ExcelProperty(value = {"表头6"},index = 7)
    private Date p8;

    @ExcelProperty(value = {"表头7"},index = 8)
    private String p9;

    @ExcelProperty(value = {"表头8"},index = 9)
    private double p10;
